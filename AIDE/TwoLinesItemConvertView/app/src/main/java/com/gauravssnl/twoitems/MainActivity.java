    ...
    protected void onCreate(Bundle savedInstanceState)
    {
		...
		ArrayAdapter<String> stringList = new ArrayAdapter<String>(this, INVALID_LAYOUT, fruits) {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				((TextView)convertView.findViewById(R.id.itemTextView1)).setText(fruits[position]);
				((TextView)convertView.findViewById(R.id.itemTextView2)).setText(colors[position]);
				return convertView;
